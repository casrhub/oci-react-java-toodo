...
public class KpiController {
    ...
    @PutMapping("/{kpiId}")
    public ResponseEntity<Kpi> updateKpi(@PathVariable("kpiId") Long kpiId, @RequestBody Kpi updatedKpi) {
    ...
    @GetMapping
    public ResponseEntity<List<Kpi>> getAllKpis(@RequestParam(value = "usuarioId", required = false) Long usuarioId) {
