...
public class UsuariosControllerTest {
  ...
  private Usuarios buildUsuario(
          Integer id, String nombre, String email, String rol, Integer equipoId) {
    Usuarios u = new Usuarios();
    u.setId(id);
    u.setNombre(nombre);
    u.setEmail(email);
    u.setRol(rol);
    u.setEquipoId(equipoId);
    return u;
  }

  @Test
  void testCreateAndGetUsuario() throws Exception {
    Usuarios input = buildUsuario(
            null,
            "Diego Ivan Morales",
            "a01643382@tec.mx",
            "developer",
    ...
    mockMvc.perform(get(BASE_URL + "/1"))
            ...
            .andExpect(jsonPath("$.nombre")
                    .value("Diego Ivan Morales"))
            .andExpect(jsonPath("$.email")
                    .value("a01643382@tec.mx"))
            .andExpect(jsonPath("$.rol")
                    .value("developer"))
            .andExpect(jsonPath("$.equipo_id")
                    .value(1));
  }

  @Test
  void testUpdateUsuario() throws Exception {
    Usuarios existing = buildUsuario(
            1,
            "Diego Ivan Morales",
            "a01643382@tec.mx",
            "developer",
    ...
    mockMvc.perform(put(BASE_URL + "/1")
            ...
            .andExpect(jsonPath("$.usuario_id").value(1))
            .andExpect(jsonPath("$.nombre")
                    .value("Diego Ivan Morales Gallardo"))
            .andExpect(jsonPath("$.rol")
                    .value("manager"));
  }

  @Test
  void testGetAllUsuariosAndByEquipoAndByRol() throws Exception {
  ...
  void testUpdateUsuario_ManagerMultiRole_BadRequest() throws Exception {
    ...
    mockMvc.perform(put(BASE_URL + "/1")
            ...
            .andExpect(jsonPath("$.error")
                    .value("El usuario con rol manager no puede tener otro rol"));
  }
}
