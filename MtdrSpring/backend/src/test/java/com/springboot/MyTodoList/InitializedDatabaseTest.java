...
public class InitializedDatabaseTest {
    ...
    static OracleContainer oracleContainer = new OracleContainer("gvenzl/oracle-free:23.6-slim-faststart")
            .withStartupTimeout(Duration.ofMinutes(10))  // Increased timeout
    ...
    void getUsuario() throws SQLException {
        ...
        try (Connection conn = ds.getConnection();
             ...
             ResultSet rs = stmt.executeQuery("select * from USUARIOS where USUARIO_ID = 104")) {
            Assertions.assertTrue(rs.next());
            assertThat(rs.getString(2)).isEqualTo("Miguel Angel Barrientos Ballesteros");
        }
    }
}