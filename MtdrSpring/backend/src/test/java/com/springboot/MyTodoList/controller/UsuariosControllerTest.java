...
public class UsuariosControllerTest {
    ...
    public void updateUserTest() throws Exception {
        ...
        Mockito.when(usuarioService.findById(1)).thenReturn(Optional.of(existingUsuario)); // MOCK find by ID

        Mockito.when(usuarioService.save(Mockito.any(Usuarios.class))).thenReturn(updatedUsuario); // MOCK save
